...
- [docs/code-verification.md](docs/code-verification.md) - how to structure specs, checks, and review so a completion claim about agent-built work is trustworthy.
